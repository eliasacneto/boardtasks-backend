...
Projeto em Express.js do BoardTasks Back-End feito para a escola DNC.
...
2) Você precisa copiar o arquivo `sample.env` que está na pasta raiz daquele projeto e renomeá-lo para .env para que as variáveis de ambiente sejam definidas.
